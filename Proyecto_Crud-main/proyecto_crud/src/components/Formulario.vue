...
<template>
    ...
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input v-model="nombre" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-grey-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="nombre" type="text" placeholder="Nombre">
    </div>
  ...
  <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
    ...
    <button @click="Enviar()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="button">
        Enviar
    </button>
